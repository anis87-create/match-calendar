export const leagueNames = {
  ...
  coupetr: "Coupe de Turquie",
  spl: "Saudi Pro League",
  caf: "Champ. CAF",
  supercoupefr: "Trophée des Champions",
  supercoupede: "Supercoupe d'Allemagne",
  supercoupeen: "Community Shield",
  supercoupees: "Supercopa d'Espagne",
  supercoupeit: "Supercoppa Italienne",
  supercoupeaf: "Supercoupe d'Afrique",
  supercoupeeu: "Supercoupe d'Europe",
  euroq: "Qualif. Euro",
  canq: "Qualif. CAN",
  nationsleague: "Ligue des Nations UEFA",
...
export const leaguePillClass = {
  ...
  cuptun: "pill-cuptun",
  coupetr: "pill-coupetr",
  spl: "pill-spl",
  caf: "pill-caf",
  supercoupefr: "pill-supercoupefr",
  supercoupede: "pill-supercoupede",
  supercoupeen: "pill-supercoupeen",
  supercoupees: "pill-supercoupees",
  supercoupeit: "pill-supercoupeit",
  supercoupeaf: "pill-supercoupeaf",
  supercoupeeu: "pill-supercoupeeu",
  euroq: "pill-euroq",
  canq: "pill-canq",
  nationsleague: "pill-nationsleague",
  wcq_afr: "pill-wcq",
  wcq_eur: "pill-wcq",
  wcq_asi: "pill-wcq",
  wcq_sam: "pill-wcq",
